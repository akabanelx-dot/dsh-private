...
| 包名 | 版本 | 安装来源 | 状态 | 作用 |
|---|---|---|---|---|
| `dsh-auto-approve` | 0.1.0 | link → `F:\WorkSpace\DSH\dsh-auto-approve`（源码已入库 [akabanelx-dot/dsh-plugins](https://github.com/akabanelx-dot/dsh-plugins)） | active | Codex 风格自动批准：检测到沙箱提权时自动放行，附审计 |
